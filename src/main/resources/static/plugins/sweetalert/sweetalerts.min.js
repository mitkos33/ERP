  ...
  $("#basic-alert").on("click", function () {
    ...
    $("#custom-icon").on("click", function () {
      Swal.fire({
        ...
        imageUrl: "../../../app-/images/slider/04.jpg",
        imageWidth: 400,
        imageHeight: 200,
    ...
    $(".confirm-text").on("click", function () {
      ...
      let title = $("#delete_title").val();
      let message = $("#delete_message").val();
      let yesButtonText = $("#delete_yes_button").val();
      let closeButtonText = $("#delete_close_button").val();
